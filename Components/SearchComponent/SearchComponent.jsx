...
const SearchComponent = (props) => {
    ...
    return (
        <div className='filmbox__searched'>
            <Link onClick={detailsClick} to='/MovieDetails' className='searched-link'>
                <div className='filmbox__searched'>
                    <picture>
                        <img src={getImage(backdrop_path || poster_path)} alt={title} className='filmbox__searched-image' />
                    </picture>
                    <article>
                        <h2 className='filmbox__searched-title'>{title || name}</h2>
                        <p className='filmbox__searched-overview'>{overview}</p>
                    </article>
                </div>
            </Link>
        </div>
